...
void SmtpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (SmtpClient::*)(SmtpClient::SmtpError );
            if (_q_method_type _q_method = &SmtpClient::error; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (SmtpClient::*)(SmtpClient::ClientState );
            if (_q_method_type _q_method = &SmtpClient::stateChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (SmtpClient::*)();
            if (_q_method_type _q_method = &SmtpClient::connected; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _q_method_type = void (SmtpClient::*)();
            if (_q_method_type _q_method = &SmtpClient::readyConnected; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _q_method_type = void (SmtpClient::*)();
            if (_q_method_type _q_method = &SmtpClient::authenticated; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            using _q_method_type = void (SmtpClient::*)();
            if (_q_method_type _q_method = &SmtpClient::mailSent; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
        {
            using _q_method_type = void (SmtpClient::*)();
            if (_q_method_type _q_method = &SmtpClient::mailReset; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 6;
                return;
            }
        }
        {
            using _q_method_type = void (SmtpClient::*)();
            if (_q_method_type _q_method = &SmtpClient::disconnected; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 7;
                return;
            }
        }
